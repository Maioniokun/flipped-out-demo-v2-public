...
class HealthIcon extends FlxSprite
{
	...
	public function new(char:String = 'face', isPlayer:Bool = false, ?_id:Int = -1)
	{
		...
		if(Config.betterIcons){
			...
			animation.add('bf-carry', [0, 1, 30], 0, false, isPlayer);
			...
			animation.add('flippy', [51, 52, 53], 0, false, isPlayer);
			animation.add('flippy-blood', [51, 52, 53], 0, false, isPlayer);
			animation.add('flippy-cool', [51, 52, 53], 0, false, isPlayer);
			...
			animation.add('bf-carry', [0, 1], 0, false, isPlayer);
			...
			animation.add('flippy', [51, 52], 0, false, isPlayer);
			animation.add('flippy-cool', [51, 52], 0, false, isPlayer);
		}
