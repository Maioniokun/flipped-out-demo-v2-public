...
class Note extends FlxSprite
{
	...
	public var noteSpec:Float = 0;
	public var sustainLength:Float = 0;
	public var isSustainNote:Bool = false;
	public var camoNote:Bool = false;
	public var nadeNote:Bool = false;
	public var burnNote:Bool = false;
	...
	public function new(_strumTime:Float, _noteData:Int, ?_editor = false, ?_prevNote:Note, ?_sustainNote:Bool = false, ?noteType:Float = 0)
	{
		swagWidth = 160 * 0.7;
		noteScale = 0.7;
		super();
		...
		switch (daStage)
		{
			...
			frames = FlxAtlasFrames.fromSparrow('assets/images/camoNotes.png', 'assets/images/camoNotes.xml');
			animation.addByPrefix('greenScroll', 'camo up');
			animation.addByPrefix('redScroll', 'camo right');
			animation.addByPrefix('blueScroll', 'camo down');
			animation.addByPrefix('purpleScroll', 'camo left');
			setGraphicSize(Std.int(width * noteScale));
			updateHitbox();
			antialiasing = true;
			camoNote = true;
			...
			frames = FlxAtlasFrames.fromSparrow('assets/images/nadeNotes.png', 'assets/images/nadeNotes.xml');
			animation.addByPrefix('greenScroll', 'nade up');
			animation.addByPrefix('redScroll', 'nade right');
			animation.addByPrefix('blueScroll', 'nade down');
			animation.addByPrefix('purpleScroll', 'nade left');
			setGraphicSize(Std.int(width * noteScale));
			updateHitbox();
			antialiasing = true;
			nadeNote = true;
			...
			frames = FlxAtlasFrames.fromSparrow('assets/images/burnNotes.png', 'assets/images/burnNotes.xml');
			animation.addByPrefix('greenScroll', 'burn up');
			animation.addByPrefix('redScroll', 'burn right');
			animation.addByPrefix('blueScroll', 'burn down');
			animation.addByPrefix('purpleScroll', 'burn left');
			setGraphicSize(Std.int(width * noteScale));
			updateHitbox();
			antialiasing = true;
			burnNote = true;
