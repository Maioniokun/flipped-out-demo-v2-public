	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'monster-christmas':
				...
				playAnim('idle');
			case 'flippy':
				frames = Paths.getSparrowAtlas("flippy/FLIPPY_onslaught");
			...
			case 'flippy-blood':
				frames = Paths.getSparrowAtlas("flippy/FLIPPY_bloody");
				animation.addByPrefix('idle', "FLIPPY Idle", 24, true);
				animation.addByPrefix('singUP', 'FLP M UP', 24, false);
				animation.addByPrefix('singDOWN', 'FLP M DOWN', 24, false);
				animation.addByPrefix('singLEFT', 'FLP M LEFT', 24, false);
			...
			case 'flippy-cool':
				frames = Paths.getSparrowAtlas("flippy/FLIPPY_Cicerega");
				animation.addByPrefix('idle', "FLIPPY Idle", 24, true);
				animation.addByPrefix('singUP', 'FLP M UP', 24, false);
				animation.addByPrefix('singDOWN', 'FLP M DOWN', 24, false);
				animation.addByPrefix('singLEFT', 'FLP M LEFT', 24, false);
			...
			case 'bf-carry':
				frames = Paths.getSparrowAtlas("BF_Carry");
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
				animation.addByPrefix('singRIGHT', 'BF NOTE RIGHT0', 24, false);
